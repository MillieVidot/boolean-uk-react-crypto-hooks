...
import useSetInterval from "../hooks/setInterval"
import useSetCounter from "../hooks/setCounter"
import useFetchCriptoUpdate from "../hooks/fetchCriptoUpdate"
...
export default function MainDetail({
  ...
  const [currTime] = useSetInterval()
  const [counter, setCounter, playTicker, setPlayTicker] = useSetCounter()
  useFetchCriptoUpdate(counter, setCounter, id, updateCryptoData)
